...
CREATE TABLE silver.dataco_supply_chain (
    ...
    earning_per_order                DECIMAL(18,4),     -- from [Benefit per order]
    ...
    customer_zipcode                 INT,               -- from [Customer Zipcode]
    ...
    order_profit_per_order           DECIMAL(18,4),     -- from [Order Profit Per Order]
    ...
    order_zipcode                    DECIMAL(12,0),     -- from [Order Zipcode]
    ...
    customer_street_number           VARCHAR(255),      -- newly added
    customer_street_name             VARCHAR(255),      -- newly added
